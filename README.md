    ...
    <table>
        <tr>
            <td width="60%" align="left">
                <p>💼 <strong>Senior Android Developer</strong> with 5+ years of experience specializing in native Android development</p>
                <p>🔭 Currently working on <strong>enterprise-level applications</strong> using Kotlin Multiplatform</p>
                <p>🌱 Expanding expertise in <strong>backend development with Kotlin</strong> and <strong>CI/CD pipelines</strong></p>
                <p>💡 Passionate about <strong>clean code, testing, and performance optimization</strong></p>
                <p>📚 Regularly contributing to <strong>open-source projects</strong> and writing technical articles</p>
                <p>🎯 Focused on creating <strong>scalable, maintainable, and user-centric applications</strong></p>
            </td>
            <td width="40%" align="center">
                <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExeW51bDZrc2hsMXg4aHQ0bnd2aW1mdjloOWxneTR1ajBpeWlqaXAwciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/26tn33aiTi1jkl6H6/giphy.gif" width="200"/>
            </td>
        </tr>
    </table>
</div>
...
<div align="center">
    ...
    <br/>
    <p>© 2024 Aya Sheta • Crafting excellence in mobile development</p>
</div>
